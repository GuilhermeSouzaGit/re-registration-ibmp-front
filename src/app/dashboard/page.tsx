		...
		<>
			...
			<div className="flex flex-col gap-8 p-4 md:p-8 xl:p-16">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16">
					<div className="flex flex-col items-center p-4 text-white bg-[#0055D4] rounded-2xl font-bold w-full">
						<p className="text-[#BEBEBE] text-2xl">
							Número de Membros
						</p>
						<h2 className="text-3xl">89</h2>
					</div>
					<div className="flex flex-col items-center p-4 text-white bg-[#0055D4] rounded-2xl font-bold w-full">
						<p className="text-[#BEBEBE] text-2xl">
							Número de Batismos
					...
					<div className="flex flex-col items-center p-4 text-white bg-[#0055D4] rounded-2xl font-bold w-full">
						...
						<h2 className="text-3xl">24/02</h2>
					</div>
				</div>
				<div>
					<div className="flex flex-col items-center p-4 text-white bg-[#0055D4] rounded-2xl font-bold w-full">
				...
				<div>
					<div className="flex flex-col items-center p-4 text-white bg-[#0055D4] rounded-2xl font-bold w-full">
						...
						<h2 className="text-3xl">04/02/2024</h2>
					</div>
				</div>
			</div>
		</>
